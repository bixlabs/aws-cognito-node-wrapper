...
class UserService {
   ...
   *           UserAttributes:
   *             type: array
   *             description: An array of name-value pairs that contain user attributes and attribute values to be set
   *             for the user to be created. An email attribute is required. For custom attributes a custom: prefix must be included
   *             $ref: '#/definitions/userAttributes'
   *     responses:
   *       200:
